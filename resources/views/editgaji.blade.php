    ...
    @foreach ($gaji as $g)
        ...
        <div class="mb-5">
            ...
            <input type="number" name="id_pegawai" id="id_pegawai"
                ...
                placeholder="" required value="{{ $g->Pegawai_id }}"/>
        </div>
        <div class="mb-5">
            ...
            <input type="number" name="gaji" id="gaji"
                class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-xs-light"
                placeholder="" required value="{{ $g->Jumlah_gaji }}"/>
        </div>
        <div class="mb-5">
            ...
            <input type="number" name="jlembur" id="jlembur"
                class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-xs-light"
                placeholder="" required value="{{ $g->Jumlah_lembur }}"/>
        </div>
        <div class="mb-5">
            ...
            <input type="number" name="potongan" id="potongan"
                class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-xs-light"
                placeholder="" required value="{{ $g->Potongan }}"/>
        </div>
        <div class="mb-5">
            ...
            <input type="number" name="gaji_diterima" id="gaji_diterima"
                class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-xs-light"
                placeholder="" required value="{{ $g->Gaji_diterima }}"/>
        </div>
        <button type="submit"
