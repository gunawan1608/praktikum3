                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="w-12 h-12 bg-blue-400 bg-opacity-20 rounded-xl flex items-center justify-center">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M16 4c0-1.11.89-2 2-2s2 .89 2 2-.89 2-2 2-2-.89-2-2zM4 18v-4h3v4h2v-7.5c0-.83.67-1.5 1.5-1.5S12 9.67 12 10.5V11h2.5c.83 0 1.5.67 1.5 1.5V18h2v-6.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5V18h2v-6.5c0-1.38-1.12-2.5-2.5-2.5H18c-1.38 0-2.5 1.12-2.5 2.5V18H4z" />
                            </svg>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold">{{ $pegawai ? $pegawai->pluck('jabatan')->unique()->count() : 0 }}
                            </p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold">
                                {{ $pegawai && $pegawai->count() > 0 ? round($pegawai->avg('umur'), 0) : 0 }} Th</p>
                        </div>
                            ...
                            @foreach ($pegawai as $p)
                                <tr class="hover:bg-slate-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-12 w-12">
                                                <div
                                                    class="h-12 w-12 rounded-full bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500 flex items-center justify-center shadow-lg">
                                                    <span
                                                        class="text-white font-bold text-lg">{{ substr($p->nama, 0, 1) }}</span>
                                                </div>
                                            </div>
                                            <div class="ml-4">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @endphp
                                        <span
                                            class="inline-flex items-center px-3 py-1.5 rounded-xl text-sm font-medium border {{ $jabatanClass }}">
                                            <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                                                <path
                                                    d="M20 6h-2.18c.11-.31.18-.65.18-1a2.996 2.996 0 0 0-5.5-1.65l-.5.67-.5-.68C10.96 2.54 10 2 10 2 10 2 10 2 10 2s0 0 0 0c-1.66 0-3 1.34-3 3 0 .35.07.69.18 1H5c-1.1 0-2 .9-2 2v1c0 .55.45 1 1 1h1v10c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V10h1c.55 0 1-.45 1-1V8c0-1.1-.9-2-2-2z" />
                                            </svg>
                                            {{ $p->jabatan }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="flex items-center">
                                            <span
                                                class="inline-flex items-center px-3 py-1.5 rounded-xl text-sm font-medium {{ $umurClass }}">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-slate-900 max-w-xs">
                                            <div class="flex items-start">
                                                <svg class="w-4 h-4 text-slate-400 mt-0.5 mr-2 flex-shrink-0"
                ...
                @if ($pegawai->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <a href="pegawai/tambah">
                            <button
                                class="inline-flex items-center px-6 py-3 text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-xl font-medium shadow-lg transition-all duration-200 transform hover:-translate-y-0.5">
