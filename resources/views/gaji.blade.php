...
<body>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    ...
                    <li>
                        <a href="gaji"
                            class="block py-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500">Gaji</a>
                    </li>
                    <li>
                        <a href="lembur"
    ...
    <div class="flex justify-between">
        <h1 class="mt-5 text-5xl font-extrabold dark:text-white ml-4">Data Gaji</h1>
        <a href="gaji/tambah" class="mr-4">
            <button type="button"
